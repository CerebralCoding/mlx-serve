...
- **Speculative decoding** — PLD (model-agnostic n-gram lookup, on by default) and the Gemma 4 assistant drafter. Adaptive prompt-time gate keeps novel content at parity; agentic code-edit loops see up to 1.6×.
